...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private Uri petUriEdit;
    private static final int EXISTING_PET_LOADER = 0;
    // boolean value to track the any edit text was changed or not
    private boolean mPetHasChanged = false;
    // create listener to set it into the edit text
    ...
    private void savePet() {
        ...
        if (petUriEdit == null && TextUtils.isEmpty(name) && TextUtils.isEmpty(breed) && TextUtils.isEmpty(weight) && mGender == PetEntry.GENDER_UNKNOWN) {
            return;
        }
        ...
        if (petUriEdit == null) {
            ...
            int rowsAffected = getContentResolver().update(petUriEdit, values, null, null);
            if (rowsAffected == 0) {
    ...
    private void deletePet() {
        ...
        int rowsDeleted = getContentResolver().delete(petUriEdit, null, null);
        if (rowsDeleted == 0) {
    ...
    public Loader<Cursor> onCreateLoader(int id, Bundle args) {
        ...
        return new CursorLoader(this, petUriEdit, projection, null, null, null);
    }
    ...
    public void onLoaderReset(Loader<Cursor> loader) {
        ...
        GenderSpinner.setSelection(0); // the default choose is: UNKNOWN
    }
}